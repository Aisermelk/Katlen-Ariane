...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const topWhatsappPill = document.getElementById("top-whatsapp-pill");
    const topWhatsappText = document.getElementById("top-whatsapp-text");
    if (config.whatsapp) {
        topWhatsappText.textContent = config.whatsapp;
        topWhatsappPill.style.display = "flex";
    }
    const topAddressPill = document.getElementById("top-address-pill");
    const topAddressText = document.getElementById("top-address-text");
    if (config.endereco) {
        topAddressText.textContent = config.endereco;
        topAddressPill.style.display = "flex";
    }
